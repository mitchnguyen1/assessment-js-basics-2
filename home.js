...
console.log("Problem 2:",canWeDeliver(85205))
...
console.log("Problem 2.5:",canWeDeliverTwo(85245))
...
//CODE HERE
//grab the value with it's property
//assign it to the output of replacing 15 with 10 --- 10% Off! is the output              
deals[0].title = deals[0].title.replace("15","10")
console.log("Problem 3:",deals)
...
//CODE HERE
//grab the value with it's property
//assign it to the output of replacing March with April
//using trim to remove white space
deals[1].desc = deals[1].desc.replace("March","April").trim()
console.log("Problem 3.5:",deals)
